...
export const ProfileEditModal: React.FC<ProfileEditModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-xl p-0 gap-0 overflow-hidden border-none shadow-2xl flex flex-col max-h-[95vh] sm:max-h-[90vh]">
        <DialogHeader className="p-4 border-b shrink-0 flex flex-row items-center justify-between">
          <DialogTitle className="font-black text-xl">Edit Profile</DialogTitle>
          <div className="mr-8">
            <Button
            ...
            >
              {loading ? <Loader2 className="animate-spin size-4" aria-hidden="true" /> : "Save"}
            </Button>
          </div>
        </DialogHeader>
